...
// ...otherGenres - rest operator (at the end of the array)
const [primaryGenre, secondaryGenre, ...otherGenres] = genres;
console.log(primaryGenre, secondaryGenre, otherGenres);

// ...genres - spread operator (takin all elements out of array/object and placing them one by one creating new object)
...
const updatedBook = {
  ...
  pages: 1510, // this one overrides the previous/existing property
};
updatedBook;
